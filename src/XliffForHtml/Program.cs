	...
	class MainClass
	{
		public static void Main (string[] args)
		{
			...
			else if (injectFromXliff)
			{
				...
				var hdoc = injector.InjectTranslations(xliffFile);
				if (outputFile == null)
		...
		private static void Usage()
		{
			...
			Console.WriteLine("       -f|--folder <lang> = the xliff file is in a subfolder named <lang> (ignored if -x or -o)");
			...
			Console.WriteLine("       -x|--xliff <file> = specify xliff file path (ignored if -e and -o)");
