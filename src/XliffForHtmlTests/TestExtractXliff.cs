...
*/
		...
		[Test]
		public void TestCopyingMissingTransUnitsFromOldXliff_CreatesObsolete()
		{
    ...
    <body>
      ...
      <trans-unit id='integrity.title.2'>
        ...
        <note>Obsolete in 5.2</note>
			...
			//SUT
			HtmlXliff.CopyMissingUnitsAsObsoleteToNewXliff(newXliff, oldXliff);
			...
			CheckXliffWithNotes(tu, "integrity.title", 4, "Bloom cannot find some of its own files, and cannot continue",
				new[] { "ID: integrity.title", "Obsolete for current Bloom" });
